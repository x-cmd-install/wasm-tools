...
[![x-cmd/install — wasm-tools Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/wasm-tools.svg?lang=zh)](https://x-cmd.com/install/wasm-tools)
...
合计: **2,033,096** 行代码（覆盖前 5 种语言、共 **2560** 个文件）。
...
- **Star**: 1,790 · **Fork**: 357 · **开放 issue**: 474 · **贡献者**: 199

## 累计统计

- **发布数**: 121 · **已合并 PR**: 2058 · **开放 PR**: 17 · **已关闭 issue**: 365 · **开放 issue**: 109 · **提交数**: 3359
...
_数据快照: `data/card/260925.yml` · 2026-09-25T05:11:58Z._
